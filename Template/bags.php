...
<section id="bags" class="my-3">
    ...
    <div class="row mx-auto container-fluid">
            <?php foreach ($product_bags as $item) { ?>
            <div class="product text-center col-lg-3 con-md-4 col-12">
                <a href="<?php printf('%s?itemID=%s', 'product.php', $item['itemID']); ?>"><img class="img-fluid mb-3" src="<?php echo $item['image'] ?? "./assets/bags/1.jpg"; ?>" alt=""></a>
                <div class="star">
