...
<section id="wish" class="my-1 py-1 pb-1">
                                    ...
                                    <div class="col-md-7 col-lg-9 col-xl-9">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <form method="post">
                                                        <input type="hidden" value="<?php echo $item['itemID'] ?? 0; ?>" name="itemID">
                                                        <button type="submit" name="cart-submit" class="buy-btn btn btn-primary">Add To Cart</button>
                                                    </form>

                                                <span class="ml-auto" >$ <?php echo $item['price'] ?? 0; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
