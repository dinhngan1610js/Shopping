...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if (isset($_POST['dress_submit'])){
        $Cart->addToCart($_POST['userID'], $_POST['itemID']);
    }
}
?>
<section id="dress" class="my-3">
    <div class="container text-center mt-5 py-5">
        <h3>Bloom your bright</h3>
        <hr class="mx-auto">
    ...
    <div class="row mx-auto container-fluid">
            <?php foreach ($product_dress as $item) { ?>
                <div class="product text-center col-lg-3 con-md-4 col-12">
                    <a href="<?php printf('%s?itemID=%s', 'product.php', $item['itemID']); ?>"><img class="img-fluid mb-3" src="<?php echo $item['image'] ?? "./assets/dress/1.webp"; ?>" alt=""></a>
                    <div class="star">
                    ...
                    <form method="post">
                        ...
                        if (in_array($item['itemID'],$Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="dress_submit" class="buy-btn btn btn-primary">Add To Cart</button>';
                        }
                        ?>
                    </form>
                </div>
