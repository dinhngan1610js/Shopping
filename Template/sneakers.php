...
<!--    <div class="more">-->
        <div class="row mx-auto container-fluid">
            <?php foreach ($product_sneakers as $item) { ?>
                <div class="product text-center col-lg-3 con-md-4 col-12">
                    <a href="<?php printf('%s?itemID=%s', 'product.php', $item['itemID']); ?>"><img class="img-fluid mb-3" src="<?php echo $item['image'] ?? "./assets/sneakers/1.jpg"; ?>" alt=""></a>
                    <div class="star">
                    ...
                    <form method="post">
                        ...
                        if (in_array($item['itemID'],$Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="sneakers_submit" class="buy-btn btn btn-primary">Add To Cart</button>';
                        }
                        ?>
                    </form>
                </div>
...
<!--    </div>-->
<!--    <button class="show mx-auto container-fluid">Show More</button>-->
</section>